...
<template>
    <div class="arco-result arco-result-is-500 result--lQPJd">
        <div class="arco-result-icon">
            <span class="arco-result-icon-tip arco-result-icon-404">
                            ...
                            <g transform="matrix(0.38223,0,0,0.38223,1126.12,238.549)">
                                ...
                                <g transform="matrix(1,0,0,1,275,-15)">
                                    <path
                                        ...
                                        style="fill: rgb(196, 173, 142);"></path>
                                    <g transform="matrix(0.866025,-0.5,1,0.57735,0,-45)">
                                        <ellipse cx="-848.416" cy="1004.25" rx="6.062" ry="5.25"
                                            style="fill: rgb(255, 125, 0);"></ellipse>
                                    </g>
                                </g>
                                    ...
                                    <g transform="matrix(0.750082,0,0,0.750082,163.491,354.191)">
                                        ...
                                        <g transform="matrix(0.262716,-0.151679,8.27418e-18,0.0364999,121.496,970.53)">
                                            <path
                                                ...
                                                style="fill: rgb(246, 220, 185);"></path>
                                        </g>
                                ...
                                <g>
                                    ...
                                    <g transform="matrix(2.61622,0,0,2.61622,-2305.73,162.161)">
                                        <g transform="matrix(1.09915,-0.634597,1.26919,0.73277,-299.167,-62.4615)">
                                            <ellipse cx="412.719" cy="770.575" rx="6.303" ry="5.459"
                                                style="fill: rgb(255, 125, 0);"></ellipse>
                                        </g>
                                        <g transform="matrix(0.238212,-0.137532,0.178659,0.103149,875.064,207.93)"><text
                                                x="413.474px" y="892.067px"
                                                style="font-family: NunitoSans-Bold, &quot;Nunito Sans&quot;; font-weight: 700; font-size: 41.569px; fill: white;">?</text>
                                        </g>
                                    </g>
                                </g>
                            </g>
        ...
        <div class="arco-result-subtitle">抱歉，页面不见了～</div>
        <div class="arco-result-subtitle">异常路由：{{ $route.params.undefined }}</div>
